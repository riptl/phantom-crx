...
`,D=l.default.a`
  ...
  color: ${y};
`,I=({origin:t})=>{const{t:n}=a.useTranslation(),o=t?g.removeSubdomainFromDomain(t):"";return e(i).createElement(O,null,e(i).createElement(k,null,e(i).createElement(C,null,e(i).createElement(p.LogoPhishingDetected,null)),e(i).createElement(f.Text,{size:30,color:y,weight:"600"},n("blocklistOriginDomainIsBlocked",{domainName:o||n("blocklistOriginThisDomain")})),e(i).createElement(f.Text,{color:y},n("blocklistOriginSiteIsMalicious")),e(i).createElement(f.Text,{color:y},e(i).createElement(a.Trans,{i18nKey:"blocklistOriginCommunityDatabaseInterpolated"},"This site has been flagged as part of a",e(i).createElement(D,{href:m.PHANTOM_BLOCKLIST_GITHUB_URL,rel:"noopener",target:"_blank"},"community-maintained database"),"of known phishing websites and scams. If you believe the site has been flagged in error,",e(i).createElement(D,{href:m.PHANTOM_BLOCKLIST_GITHUB_URL,rel:"noopener",target:"_blank"},"please file an issue"),".")),o?e(i).createElement(f.Text,{color:y,onClick:()=>E(void 0,void 0,void 0,(function*(){const e=yield b.getStorageValue(x.StorageKeys.UserWhitelistedOrigins);let n=JSON.parse(`${e}`);n?n.push(o):n=[o],n=[...new Set(n)],b.setStorageValue(x.StorageKeys.UserWhitelistedOrigins,JSON.stringify(n)),window.location.href=t})),hoverUnderline:!0},n("blocklistOriginIgnoreWarning",{domainName:o})):e(i).createElement(e(i).Fragment,null)))}}));define=__define;})(window.define);